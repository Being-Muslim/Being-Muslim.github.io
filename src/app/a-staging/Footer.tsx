    ...
    <footer style={css("background: #191918; padding: 64px 0 0")}>
      <div className="mx-auto max-w-[1400px] px-6 lg:px-10">
        <div className="bm-grid-footer">
          {/* Brand */}
          <div>
            <Link href="/a-staging" style={css("display: flex; align-items: center; gap: 10px; text-decoration: none; margin-bottom: 16px")}>
        ...
        <div style={css("border-top: 1px solid rgba(255,255,255,0.08); padding: 20px 0; display: flex; flex-wrap: wrap; justify-content: space-between; align-items: center; gap: 12px")}>
          ...
          <div style={css("display: flex; gap: 24px")}>
            <Link href="/a-staging" className="bm-footer-link" style={css("font-size: 12px; color: rgba(255,255,255,0.3)")}>Privacy</Link>
            <Link href="/a-staging" className="bm-footer-link" style={css("font-size: 12px; color: rgba(255,255,255,0.3)")}>Terms</Link>
            <Link href="/a-staging/contact" className="bm-footer-link" style={css("font-size: 12px; color: rgba(255,255,255,0.3)")}>Contact</Link>
          </div>
        </div>
      </div>
    </footer>
