    ...
    columns: [
      {
        heading: "Resources",
        links: [
          { label: "Articles", href: "/a-staging/learn", desc: "In-depth guides on faith and practice" },
          { label: "Courses", href: "/a-staging/learn", desc: "Structured learning at your own pace" },
          { label: "Brief Overview of Islam", href: "/a-staging/learn/brief-overview-of-islam", desc: "Core beliefs, practices, and history" },
        ],
      },
      {
        heading: "Popular Topics",
        links: [
          { label: "Beginner's Guide", href: "/a-staging/learn/beginners-guide", desc: "First steps for new Muslims" },
          { label: "Islam and Other Faiths", href: "/a-staging/learn/islam-and-other-faiths", desc: "Common ground and key differences" },
          { label: "View All Resources", href: "/a-staging/learn" },
        ],
      },
    ],
    featured: {
    ...
    columns: [
      {
        ...
        links: [
          { label: "Ready to Convert?", href: "/a-staging/convert", desc: "Take the next step with guidance and support" },
          { label: "What to Expect", href: "/a-staging/convert", desc: "Understanding the process and what comes after" },
          { label: "FAQ for New Muslims", href: "/a-staging/convert", desc: "Answers to the most common questions" },
        ],
      },
      {
        heading: "Support",
        links: [
          { label: "Find a Community", href: "/a-staging/convert", desc: "Connect with Muslims near you" },
          { label: "Mentorship Program", href: "/a-staging/convert", desc: "One-on-one guidance from experienced Muslims" },
          { label: "Start Your Journey", href: "/a-staging/convert" },
        ],
      },
    ],
  },
    ...
    columns: [
      {
        heading: "Products",
        links: [
          { label: "Being Muslim: A Practical Guide", href: "/a-staging/shop/book", desc: "The bestselling book" },
          { label: "The Complete Boxed Set", href: "/a-staging/shop/boxed-set", desc: "Book, prayer cards, and more" },
          { label: "Prayer Reference Cards", href: "/a-staging/shop/prayer-cards", desc: "Keep by your prayer mat" },
          { label: "Digital Edition (eBook)", href: "/a-staging/shop/ebook", desc: "Read anywhere, instantly" },
        ],
      },
    ],
    featured: {
    ...
    columns: [
      {
        ...
        links: [
          { label: "Donate", href: "/a-staging/support", desc: "Help fund resources for new Muslims" },
          { label: "Sponsor a Boxed Set", href: "/a-staging/support", desc: "Gift a set to someone in need" },
          { label: "Volunteer", href: "/a-staging/support", desc: "Join our team of contributors" },
          { label: "Support the Mission", href: "/a-staging/support" },
        ],
      },
    ],
  },
...
export default function Navbar() {
  ...
  return (
    <header
      ...
      style={solid ? css("background: rgba(255,255,255,0.95)") : undefined}
    >
      <nav className="mx-auto flex h-[72px] max-w-[1400px] items-center justify-between px-6 lg:px-10">
        {/* Logo */}
        <Link href="/a-staging" className="flex items-center gap-2.5">
      ...
      <div className={`mobile-menu md:hidden ${mobileOpen ? "open" : ""}`}>
        <div className="border-t border-border px-6 py-4">
          ...
          <Link href="/a-staging/contact" className="block mt-3 text-center bg-text-primary text-white py-2.5 rounded-full font-medium">
            Contact
          </Link>
        </div>
      </div>
