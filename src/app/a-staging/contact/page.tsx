...
export default function ConceptAStagingContact() {
      ...
      <section className="pt-28 pb-20 lg:pt-36 lg:pb-24" style={css("background: #faf9f5")}>
        <div className="max-w-[1400px] mx-auto px-6 lg:px-10">
          <div className="flex items-center gap-2 mb-6">
            <Star className="w-3.5 h-3.5" style={css("color: #2a2018")} />
          ...
          <div className="grid lg:grid-cols-[1.2fr_1fr] gap-12 lg:gap-20">
            ...
            <div>
              ...
              <p className="text-[15px] leading-[1.75]" style={css("color: #8a7e70")}>
                ...
                grew, through community demand, into boxed sets, prayer cards, weekend intensives,
                and a growing digital platform. From grassroots work across the United States to
            ...
            {testimonials.map((t) => (
              <div key={t.name} className="p-7" style={css("background: #f4f1eb; border-radius: 10px")}>
                <div className="flex gap-1 mb-4">
                  {[0, 1, 2, 3, 4].map((i) => (
                    <Star key={i} className="w-3.5 h-3.5" style={css("color: #c4a97d; fill: #c4a97d")} />
                  ))}
                </div>
