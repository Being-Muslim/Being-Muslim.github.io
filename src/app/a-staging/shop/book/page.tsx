...
const languageThumbs = [
  { label: "English", href: "/a-staging/shop/book", active: true },
  { label: "Español", href: "/a-staging/shop/book/spanish", active: false },
  { label: "Português", href: "/a-staging/shop/book/portuguese", active: false },
];
...
export default function ConceptAStagingShopBook() {
  return (
    <>
      {/* Breadcrumb */}
      ...
      <section style={css("background: #f0ebe3")}>
        <div className="mx-auto max-w-[1400px] px-6 lg:px-10 py-12">
          {/* Language switcher (translated editions) */}
          <div style={css("display: flex; flex-wrap: wrap; align-items: center; gap: 10px; margin-bottom: 28px")}>
            <span className="inline-flex items-center gap-1.5" style={css("font-family: 'DM Sans', sans-serif; font-size: 12px; font-weight: 600; color: #8a7e70; text-transform: uppercase; letter-spacing: 0.06em")}>
              <Globe className="h-3.5 w-3.5" />
              Languages
            </span>
            {languageThumbs.map((lang) => (
              <Link
                key={lang.label}
                href={lang.href}
                style={css(`font-family: 'DM Sans', sans-serif; font-size: 13px; font-weight: 500; text-decoration: none; border-radius: 999px; padding: 6px 14px; border: 1px solid ${lang.active ? "#2a2018" : "#d4cec4"}; color: ${lang.active ? "#faf2e3" : "#2a2018"}; background: ${lang.active ? "#2a2018" : "transparent"}`)}
              >
                {lang.label}
              </Link>
            ))}
            <Link
              ...
              style={css("font-family: 'DM Sans', sans-serif; font-size: 13px; font-weight: 500; color: #8b2e36; text-decoration: none; margin-left: 4px")}
            >
              View all languages
            </Link>
          </div>
          ...
          <div className="bm-grid-detail">
            ...
            <div style={css("font-family: 'DM Sans', sans-serif")}>
              ...
              <p style={css("font-size: 14px; color: #8a7e70; margin: 0 0 16px")}>By Dr. Asad Tarsin</p>
