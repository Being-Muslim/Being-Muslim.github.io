...
export const metadata = {
  title: "Ser Musulmán: Una Guía Práctica (Español) — Being Muslim Shop",
  description:
    "Spanish (Español) edition of Being Muslim: A Practical Guide by Dr. Asad Tarsin — the essential guide for new Muslims.",
};
...
export default function ConceptAStagingShopBookSpanish() {
  return (
    <>
      {/* Breadcrumb */}
      ...
      <section style={css("background: #2a2018")}>
        <div className="mx-auto max-w-[1400px] px-6 lg:px-10 py-3 flex items-center gap-3">
          ...
          <span style={css("font-family: 'DM Sans', sans-serif; font-size: 13px; color: #f0ebe3; letter-spacing: 0.04em")}>
            You are viewing the <strong>Español</strong> (Spanish) edition.{" "}
          ...
          <div className="bm-grid-detail">
            ...
            <div style={css("background: #e2dcd2; border-radius: 16px; overflow: hidden; aspect-ratio: 3/4")}>
              ...
              <img
                ...
                alt="Ser Musulmán: Una Guía Práctica"
            ...
            <div style={css("font-family: 'DM Sans', sans-serif")}>
              ...
              <p style={css("font-size: 14px; color: #8a7e70; margin: 0 0 16px")}>By Dr. Asad Tarsin — Spanish (Español) edition</p>
              ...
              <p style={css("font-size: 13px; color: #8a7e70; font-style: italic; line-height: 1.6; margin: 0 0 24px")}>
                A full description in Spanish (Español) is forthcoming.
              </p>
              ...
              <ul style={css("font-size: 14px; color: #5a5248; line-height: 2; margin: 0 0 32px; padding-left: 20px")}>
                ...
                <li>Spanish (Español) language edition</li>
              </ul>
