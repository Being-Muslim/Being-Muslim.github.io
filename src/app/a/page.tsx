...
const featureBoxes = [
  { label: "Learn", desc: "Explore articles, guides, and resources on Islamic faith and practice", href: "/a/learn", Icon: BookOpen },
  { label: "Convert", desc: "Take the next step on your journey with guidance and support", href: "/a/convert", Icon: Compass },
  { label: "Buy", desc: "Books, prayer cards, and resources for your journey", href: "/a/shop", Icon: ShoppingBag },
];
    ...
    <>
        ...
        <div className="relative z-10 mx-auto w-full max-w-[1400px] px-6 pt-32 pb-12 lg:px-10">
          <div className="max-w-[680px]">
            ...
            <div className="mt-8 flex flex-wrap items-center gap-4">
              <Link href="/a/learn" className="bm-btn-white" style={css("padding: 14px 28px; font-weight: 600")}>
                Start Learning <ArrowRight className="h-4 w-4" />
              </Link>
              <Link href="/a/learn" className="bm-btn-glass" style={css("padding: 14px 28px; font-weight: 600")}>
                Explore Resources
              </Link>
            </div>
          </div>
          ...
          <div className="bm-grid-explore" style={css("background: #e3dacc; border-radius: 16px; padding: 28px 20px")}>
            <div style={css("display: flex; flex-direction: column; justify-content: space-between; padding-right: 24px")}>
              ...
              <div style={css("margin-top: 24px")}>
                <Link href="/a/learn" className="bm-btn-outline" style={css("padding: 10px 24px")}>See all resources</Link>
              </div>
            </div>
      ...
      <section className="bm-section-padding" style={css("background: #f4f1eb")}>
        <div className="mx-auto max-w-[1400px] px-6 lg:px-10">
          <div style={css("display: flex; justify-content: space-between; align-items: end; margin-bottom: 32px")}>
            ...
            <Link href="/a/learn" className="bm-view-all" style={css("font-family: 'DM Sans', sans-serif; font-size: 13px; font-weight: 500; color: #2a2018; text-decoration: none; display: inline-flex; align-items: center; gap: 4px")}>
          ...
          <div style={css("text-align: center; margin-top: 32px")}>
            <Link href="/a/learn" className="bm-btn-outline" style={css("padding: 10px 24px")}>
      ...
      <section className="bm-section-padding" style={css("background: #faf9f5")}>
        <div className="mx-auto max-w-[1400px] px-6 lg:px-10">
          ...
          <div style={css("text-align: center; margin-top: 32px")}>
            <Link href="/a/shop" className="bm-btn-outline" style={css("padding: 10px 24px")}>
        ...
        <div className="mx-auto max-w-[1400px] px-6 lg:px-10">
          <div style={css("max-width: 800px")}>
            ...
            <div style={css("margin-top: 24px; display: flex; flex-wrap: wrap; gap: 12px")}>
              <Link href="/a/learn/ask-a-question" className="bm-btn-outline" style={css("padding: 10px 24px")}>Ask a Question</Link>
              <Link href="/a/convert" className="bm-btn-dark" style={css("padding: 10px 24px")}>Ready to Convert</Link>
            </div>
          </div>
        </div>
      </section>
