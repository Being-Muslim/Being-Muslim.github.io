...
const columns = [
  { heading: "Learn", links: [{ label: "Articles", href: "/b-staging/learn" }, { label: "Resources", href: "/b-staging/learn/recommended-resources" }] },
  { heading: "Products", links: [{ label: "The Book", href: "/b-staging/shop" }, { label: "Boxed Set", href: "/b-staging/shop" }, { label: "Prayer Cards", href: "/b-staging/shop" }, { label: "eBook", href: "/b-staging/shop" }] },
  { heading: "Support", links: [{ label: "Donate", href: "/b-staging/support" }, { label: "Request Donation", href: "/b-staging/support" }, { label: "Volunteer", href: "/b-staging/support" }] },
  { heading: "Company", links: [{ label: "About Us", href: "/b-staging/contact" }, { label: "Contact", href: "/b-staging/contact" }, { label: "Convert", href: "/b-staging/convert" }, { label: "Privacy Policy", href: "/b-staging" }] },
];
    ...
    <footer style={css("background: #191918; padding: 64px 0 0")}>
      <div className="mx-auto max-w-[1400px] px-6 lg:px-10">
        <div className="bm-grid-footer">
          {/* Brand */}
          <div>
            <Link href="/b-staging" style={css("display: flex; align-items: center; gap: 10px; text-decoration: none; margin-bottom: 16px")}>
        ...
        <div style={css("border-top: 1px solid rgba(255,255,255,0.08); padding: 20px 0; display: flex; flex-wrap: wrap; justify-content: space-between; align-items: center; gap: 12px")}>
          ...
          <div style={css("display: flex; gap: 24px")}>
            <Link href="/b-staging" className="bm-footer-link" style={css("font-size: 12px; color: rgba(255,255,255,0.3)")}>Privacy</Link>
            <Link href="/b-staging" className="bm-footer-link" style={css("font-size: 12px; color: rgba(255,255,255,0.3)")}>Terms</Link>
            <Link href="/b-staging/contact" className="bm-footer-link" style={css("font-size: 12px; color: rgba(255,255,255,0.3)")}>Contact</Link>
          </div>
        </div>
      </div>
    </footer>
