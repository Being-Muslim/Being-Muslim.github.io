...
const columns = [
  ...
  { heading: "Shop", links: [{ label: "The Book", href: "/b-staging/shop" }, { label: "Boxed Set", href: "/b-staging/shop" }, { label: "Prayer Cards", href: "/b-staging/shop" }, { label: "eBook", href: "/b-staging/shop" }] },
