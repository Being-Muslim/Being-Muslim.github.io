...
const featureBoxes = [
  { label: "Learn", desc: "Explore articles, guides, and resources on Islamic faith and practice", href: "/b-staging/learn", Icon: BookOpen },
  { label: "Convert", desc: "Take the next step on your journey with guidance and support", href: "/b-staging/convert", Icon: Compass },
  { label: "Buy", desc: "Books, prayer cards, and resources for your journey", href: "/b-staging/shop", Icon: ShoppingBag },
];
    ...
    <>
      ...
      <section className="bm-section-padding" style={css("background: #f4f1eb")}>
        <div className="mx-auto max-w-[1400px] px-6 lg:px-10">
          <div style={css("display: flex; justify-content: space-between; align-items: end; margin-bottom: 32px")}>
            ...
            <Link href="/b-staging/learn" className="bm-view-all" style={css("font-family: 'DM Sans', sans-serif; font-size: 13px; font-weight: 500; color: #2a2018; text-decoration: none; display: inline-flex; align-items: center; gap: 4px")}>
          ...
          <div className="bm-grid-bento">
            ...
            <Link href="/b-staging/learn/brief-overview-of-islam" style={css("display: block; text-decoration: none; border-radius: 12px; overflow: hidden; background: #e2dcd2")} className="bm-title-underline-parent">
              {/* eslint-disable-next-line @next/next/no-img-element */}
            ...
            <Link href="/b-staging/learn/beginners-guide" className="bm-grid-article-card bm-title-underline-parent" style={css("text-decoration: none")}>
            ...
            <Link href="/b-staging/learn/islam-and-other-faiths" className="bm-grid-article-card bm-title-underline-parent" style={css("text-decoration: none")}>
              <div style={css("background: #e2dcd2; border-radius: 10px; overflow: hidden; height: 100%")}>
                {/* eslint-disable-next-line @next/next/no-img-element */}
            ...
            <Link href="/b-staging/learn/brief-overview-of-islam" style={css("display: block; text-decoration: none")} className="bm-title-underline-parent">
      ...
      <section className="bm-section-padding" style={css("background: #faf9f5")}>
        <div className="mx-auto max-w-[1400px] px-6 lg:px-10">
          ...
          <div style={css("text-align: center; margin-top: 32px")}>
            <Link href="/b-staging/shop" className="bm-btn-outline" style={css("padding: 10px 24px")}>
        ...
        <div className="mx-auto max-w-[1400px] px-6 lg:px-10">
          <div style={css("max-width: 800px; margin: 0 auto")}>
            ...
            <div style={css("margin-top: 24px; display: flex; flex-wrap: wrap; gap: 12px; justify-content: center")}>
              <Link href="/b-staging/learn/ask-a-question" className="bm-btn-outline" style={css("padding: 10px 24px")}>Ask a Question</Link>
              <Link href="/b-staging/convert" className="bm-btn-dark" style={css("padding: 10px 24px")}>Ready to Convert</Link>
            </div>
          </div>
        </div>
      </section>
