...
const languageLinks = [
  { badge: "English", href: "/b-staging/shop/book", current: true },
  { badge: "Español", href: "/b-staging/shop/book/spanish", current: false },
  { badge: "Português", href: "/b-staging/shop/book/portuguese", current: false },
];
      ...
      <section style={css("background: #f4f1eb; padding: 0 0 64px")}>
        <div className="mx-auto max-w-[1400px] px-6 lg:px-10">
          ...
          <div style={css("display: flex; flex-wrap: wrap; align-items: center; gap: 8px; margin-bottom: 24px")}>
            ...
            <Link href="/b-staging/shop/languages" style={css("font-family: 'DM Sans', sans-serif; font-size: 13px; font-weight: 500; color: #2a2018; text-decoration: none; display: inline-flex; align-items: center; gap: 4px; margin-left: 4px")} className="bm-view-all">
              All languages
            </Link>
          </div>
