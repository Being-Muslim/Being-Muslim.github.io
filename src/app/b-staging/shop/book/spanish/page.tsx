...
export const metadata: Metadata = {
  title: "Being Muslim: A Practical Guide (Español) — Being Muslim Shop",
  description:
    "The Spanish (Español) edition of Being Muslim: A Practical Guide by Dr. Asad Tarsin. A full Spanish translation is forthcoming.",
};

const otherLanguages = [
  { label: "English", badge: "English", href: "/b-staging/shop/book" },
  { label: "Português", badge: "Português", href: "/b-staging/shop/book/portuguese" },
];

export default function ConceptBStagingShopBookSpanish() {
  return (
    <>
      {/* ============ BREADCRUMB ============ */}
      ...
      <section style={css("background: #f4f1eb; padding: 0 0 64px")}>
        <div className="mx-auto max-w-[1400px] px-6 lg:px-10">
          ...
          <div style={css("display: flex; flex-wrap: wrap; gap: 8px; margin-bottom: 24px")}>
            ...
            <Link href="/b-staging/shop/languages" className="bm-btn-outline" style={css("padding: 6px 16px; font-size: 13px")}>
              All languages
            </Link>
          </div>
          ...
          <div style={css("display: grid; grid-template-columns: 1fr; gap: 40px; align-items: start")} className="md:!grid-cols-2 md:!gap-12">
            ...
            <div style={css("background: #e2dcd2; border-radius: 12px; overflow: hidden; aspect-ratio: 3/4; position: relative")}>
              ...
              <img
                src="https://www.beingmuslim.org/wp-content/uploads/2021/08/Spanish-E-Book-900x1200.png"
                alt="Being Muslim: A Practical Guide — Spanish edition"
            ...
            <div>
              ...
              <p style={css("font-family: 'DM Sans', sans-serif; font-size: 14px; color: #8a7e70; margin: 0 0 16px")}>By Dr. Asad Tarsin · Spanish edition</p>
              ...
              <div style={css("background: rgba(200,184,160,0.18); border-radius: 10px; padding: 16px 18px; margin: 0 0 24px")}>
                ...
                <p style={css("font-family: 'DM Sans', sans-serif; font-size: 13px; color: #8a7e70; line-height: 1.6; margin: 0")}>
                  A full Spanish (Español) translation of <em>Being Muslim: A Practical Guide</em> is forthcoming. The English body copy below describes the edition while the translated text is being prepared.
                </p>
              </div>
              ...
              <ul style={css("font-family: 'DM Sans', sans-serif; font-size: 14px; color: #5a5248; line-height: 2; margin: 0 0 32px; padding-left: 20px")}>
                ...
                <li>Spanish translation forthcoming</li>
              </ul>
              ...
              <div style={css("display: flex; gap: 12px; flex-wrap: wrap; margin-bottom: 24px")}>
                ...
                <Link href="/b-staging/shop/book" className="bm-btn-dark" style={css("padding: 14px 32px; font-size: 15px")}>
              ...
              <div style={css("border-top: 1px solid #d8d2c8; padding-top: 20px; display: flex; flex-wrap: wrap; gap: 24px; font-family: 'DM Sans', sans-serif; font-size: 13px; color: #8a7e70")}>
                ...
                <Link href="/b-staging/shop/languages" style={css("color: #8a7e70; text-decoration: none")} className="bm-view-all">
                  See all languages
                </Link>
              </div>
            </div>
