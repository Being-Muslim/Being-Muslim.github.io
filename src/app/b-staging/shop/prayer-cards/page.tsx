...
export default function ConceptBStagingShopPrayerCards() {
  return (
    <>
      {/* ============ BREADCRUMB ============ */}
      ...
      <section style={css("background: #f4f1eb; padding: 0 0 64px")}>
        <div className="mx-auto max-w-[1400px] px-6 lg:px-10">
          <div style={css("display: grid; grid-template-columns: 1fr; gap: 40px; align-items: start")} className="md:!grid-cols-2 md:!gap-12">
            {/* Image */}
            <div style={css("background: #e2dcd2; border-radius: 12px; overflow: hidden; aspect-ratio: 3/2")}>
            ...
            <div>
              ...
              <div style={css("display: flex; align-items: center; gap: 6px; margin-bottom: 16px")}>
                ...
                <span style={css("font-family: 'DM Sans', sans-serif; font-size: 13px; color: #8a7e70")}>4.8 (52 reviews)</span>
              </div>
