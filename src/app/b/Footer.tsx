...
const columns = [
  { heading: "Learn", links: [{ label: "Articles", href: "/b/learn" }, { label: "Courses", href: "/b/learn" }, { label: "Resources", href: "/b/learn" }] },
  ...
  { heading: "Company", links: [{ label: "About Us", href: "/b/about" }, { label: "Contact", href: "/b/contact" }, { label: "Convert", href: "/b/convert" }, { label: "Privacy Policy", href: "/b" }] },
];
