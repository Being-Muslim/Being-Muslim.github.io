...
const productHrefs: Record<string, string> = {
  "being-muslim-book": "/b/shop/book",
  "being-muslim-boxed-set": "/b/shop/boxed-set",
  "prayer-cards": "/b/shop/prayer-cards",
  "being-muslim-ebook": "/b/shop/ebook",
  "being-muslim-spanish": "/b/shop/ebook",
};
      ...
      <section style={css("background: #2a2018; padding: 80px 0 64px; position: relative; overflow: hidden")}>
        <div className="mx-auto max-w-[1400px] px-6 lg:px-10" style={css("text-align: center; position: relative; z-index: 1")}>
          ...
          <div style={css("margin-top: 20px; display: flex; gap: 12px; justify-content: center; flex-wrap: wrap")}>
            <Link href="/b/contact" className="bm-btn-glass" style={css("padding: 10px 24px; font-size: 13px")}>
              Bulk &amp; Institutional Orders <ArrowRight className="h-3.5 w-3.5" />
            </Link>
            <Link href="/b/shop/languages" className="bm-btn-glass" style={css("padding: 10px 24px; font-size: 13px")}>
                ...
                <div key={product.handle} style={css("display: contents")}>
                  ...
                  {i === 2 && (
                    <div style={css("display: flex; flex-direction: column; align-items: center; justify-content: center; border-radius: 12px; background: #f4f1eb; padding: 32px; text-align: center")}>
                      ...
                      <Link href="/b/support" style={css("font-family: 'DM Sans', sans-serif; font-size: 13px; font-weight: 500; color: #2a2018; text-decoration: none; display: inline-flex; align-items: center; gap: 4px")} className="bm-view-all">
                  ...
                  {/* Product Card */}
                  <Link href={productHrefs[product.handle] ?? "/b/shop"} style={css("text-decoration: none; display: block")} className="bm-title-underline-parent group">
