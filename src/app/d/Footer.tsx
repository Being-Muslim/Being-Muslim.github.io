...
const columns = [
  { heading: "Learn", links: [{ label: "Articles", href: "/d/learn" }, { label: "Courses", href: "/d/learn" }, { label: "Resources", href: "/d/learn" }] },
  { heading: "Products", links: [{ label: "The Book", href: "/d/shop" }, { label: "Boxed Set", href: "/d/shop" }, { label: "Prayer Cards", href: "/d/shop" }, { label: "eBook", href: "/d/shop" }] },
  { heading: "Support", links: [{ label: "Donate", href: "/d/support" }, { label: "Request Donation", href: "/d/support" }, { label: "Volunteer", href: "/d/support" }] },
  { heading: "Company", links: [{ label: "About Us", href: "/d/contact" }, { label: "Contact", href: "/d/contact" }, { label: "Convert", href: "/d/convert" }, { label: "Privacy Policy", href: "/d" }] },
];
    ...
    <footer style={css("background: #191918; padding: 64px 0 0")}>
      <div className="mx-auto max-w-[1400px] px-6 lg:px-10">
        <div className="bm-grid-footer">
          {/* Brand */}
          <div>
            <Link href="/d" style={css("display: flex; align-items: center; gap: 10px; text-decoration: none; margin-bottom: 16px")}>
        ...
        <div style={css("border-top: 1px solid rgba(255,255,255,0.08); padding: 20px 0; display: flex; flex-wrap: wrap; justify-content: space-between; align-items: center; gap: 12px")}>
          ...
          <div style={css("display: flex; gap: 24px")}>
            <Link href="/d" className="bm-footer-link" style={css("font-size: 12px; color: rgba(255,255,255,0.3)")}>Privacy</Link>
            <Link href="/d" className="bm-footer-link" style={css("font-size: 12px; color: rgba(255,255,255,0.3)")}>Terms</Link>
            <Link href="/d/contact" className="bm-footer-link" style={css("font-size: 12px; color: rgba(255,255,255,0.3)")}>Contact</Link>
          </div>
        </div>
      </div>
    </footer>
