        ...
        <div className="bm-parallax-content mx-auto w-full max-w-[1400px] px-6 pt-32 pb-12 lg:px-10" style={css(`transform: translateY(${scrollY * 0.15}px)`)}>
          <div className="max-w-[680px]">
            ...
            <div className="mt-8 flex flex-wrap items-center gap-4">
              <Link href="/e/learn" className="bm-btn-white" style={css("padding: 14px 28px; font-weight: 600")}>
                Start Learning <ArrowRight className="h-4 w-4" />
              </Link>
              <Link href="/e/learn" className="bm-btn-glass" style={css("padding: 14px 28px; font-weight: 600")}>
                Explore Resources
              </Link>
            </div>
          </div>
      ...
      <section className="bm-section-padding bm-section-flow" style={css("background: #f4f1eb")}>
        <div className="mx-auto max-w-[1400px] px-6 lg:px-10">
          <div style={css("display: flex; justify-content: space-between; align-items: end; margin-bottom: 32px")}>
            ...
            <Link href="/e/learn" className="bm-view-all" style={css("font-family: 'DM Sans', sans-serif; font-size: 13px; font-weight: 500; color: #2a2018; text-decoration: none; display: inline-flex; align-items: center; gap: 4px")}>
