		...
		<div class="bm-grid-explore" style="background: #e3dacc; border-radius: 16px; padding: 28px 20px;">
			...
			<div style="display: flex; flex-direction: column; justify-content: space-between; padding-right: 24px;">
				...
				<div style="margin-top: 24px;">
					<a href="/a-staging/learn" class="bm-btn-outline" style="padding: 10px 24px;">
						See all resources
					</a>
				</div>
			</div>
			...
			<!-- Card: Learn -->
			<a href="/a-staging/learn" class="bm-card-hover" style="background: #f0eee6; border-radius: 12px; padding: 28px; display: flex; flex-direction: column; justify-content: space-between; text-decoration: none;">
				<div>
			...
			<!-- Card: Convert -->
			<a href="/a-staging/convert" class="bm-card-hover" style="background: #f0eee6; border-radius: 12px; padding: 28px; display: flex; flex-direction: column; justify-content: space-between; text-decoration: none;">
				<div>
...
<section class="bm-section-padding" style="background: #f4f1eb;">
	<div class="mx-auto max-w-[1400px] px-6 lg:px-10">
		<div style="display: flex; justify-content: space-between; align-items: end; margin-bottom: 32px;">
			...
			<a href="/a-staging/learn" class="bm-view-all" style="font-family: 'DM Sans', sans-serif; font-size: 13px; font-weight: 500; color: #2a2018; text-decoration: none; display: inline-flex; align-items: center; gap: 4px;">
...
<section class="bm-section-padding" style="background: #faf9f5;">
	<div class="mx-auto max-w-[1400px] px-6 lg:px-10">
		...
		<div style="text-align: center; margin-top: 32px;">
			<a href="/a-staging/shop" class="bm-btn-outline" style="padding: 10px 24px;">
...
<section class="bm-section-padding" style="background: #f4f1eb;">
	<div class="mx-auto max-w-[1400px] px-6 lg:px-10">
		<div class="bm-grid-courses-header">
			<h2 style="font-family: 'Source Serif 4', serif; font-size: clamp(26px, 3.8vw, 38px); line-height: 1.15; color: #2a2018; font-weight: 400; margin: 0;">
				Learn at your own pace
			</h2>
			<p style="font-family: 'DM Sans', sans-serif; font-size: 13px; color: #8a7e70; line-height: 1.55; align-self: end; margin: 0;">
		...
		<div class="bm-grid-3">
			{#each [
				...
				<a href="/a-staging/learn" style="text-decoration: none; display: block;" class="bm-title-underline-parent">
					...
					<h3 class="bm-title-underline" style="font-size: 18px; color: #2a2018; margin: 0 0 8px; line-height: 1.3;">{course.title}</h3>
					<div style="display: flex; align-items: center; gap: 12px;">
		...
		<div style="background: #2a2018; border-radius: 16px; overflow: hidden;">
			<div class="bm-grid-2">
				...
				<div class="bm-community-panel">
					...
					<a href="/a-staging/community" class="bm-btn-white">
	...
	<div class="mx-auto max-w-[1400px] px-6 lg:px-10">
		<div class="bm-grid-2-gap">
			<div>
				...
				<a href="/a-staging/support" class="bm-btn-outline" style="padding: 10px 24px;">
	...
	<div class="mx-auto max-w-[1400px] px-6 lg:px-10">
		...
		<div class="bm-grid-3">
			{#each testimonials.slice(0, 3) as testimonial}
				<div style="background: #fff; border-radius: 12px; padding: 32px; display: flex; flex-direction: column;">
	...
	<div class="mx-auto max-w-[1400px] px-6 lg:px-10">
		<div style="max-width: 800px;">
			...
			<div style="margin-top: 24px; display: flex; flex-wrap: wrap; gap: 12px;">
				<a href="/a-staging/convert" class="bm-btn-dark" style="padding: 10px 24px;">
					Ready to Convert
				</a>
				<a href="/a-staging/contact" class="bm-btn-outline" style="padding: 10px 24px;">
					Ask a Question
				</a>
			</div>
		</div>
