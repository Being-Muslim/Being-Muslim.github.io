		...
		<div class="flex flex-col overflow-hidden rounded-xl border border-border bg-surface">
			...
			<div class="flex-1 divide-y divide-border">
				{#each forumCategories.slice(0, 4) as category}
					...
					<a href="/a-staging/community/forums" class="group flex items-center gap-4 px-6 py-4 transition-colors hover:bg-secondary/50">
			...
			<div class="border-t border-border p-4">
				<a href="/a-staging/community/forums">
		...
		<div class="flex flex-col overflow-hidden rounded-xl border border-border bg-surface">
			...
			<div class="flex-1 divide-y divide-border">
				{#each chatChannels as channel}
					<a href="/a-staging/community/chat" class="group flex items-center gap-4 px-6 py-4 transition-colors hover:bg-secondary/50">
			...
			<div class="border-t border-border p-4">
				<a href="/a-staging/community/chat">
					<Button variant="outline" class="w-full">
						{#snippet children()}
							Join Chat
							<ArrowRight class="ml-1 h-4 w-4" />
