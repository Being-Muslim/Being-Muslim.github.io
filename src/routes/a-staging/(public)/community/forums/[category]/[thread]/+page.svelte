...
<section class="border-b border-border bg-secondary/30 py-4">
	<div class="mx-auto max-w-[1280px] px-4 sm:px-6 lg:px-8">
		<nav class="flex items-center gap-2 text-sm text-text-secondary">
			<a href="/a-staging/community" class="transition-colors hover:text-text-primary">Community</a>
			<ChevronRight class="h-3.5 w-3.5" />
			<a href="/a-staging/community/forums" class="transition-colors hover:text-text-primary">Forums</a>
			<ChevronRight class="h-3.5 w-3.5" />
			<a href="/a-staging/community/forums/{data.category.slug}" class="transition-colors hover:text-text-primary">{data.category.title}</a>
			<ChevronRight class="h-3.5 w-3.5" />
				...
				<div class="rounded-xl border border-border bg-surface p-5">
					...
					<div class="mt-4 space-y-3">
						...
						<div class="flex items-center justify-between text-sm">
							...
							<a href="/a-staging/community/forums/{data.category.slug}" class="font-semibold text-accent-primary hover:underline">
								{data.category.title}
							</a>
						</div>
					</div>
				...
				<div class="rounded-xl border border-border bg-surface p-5">
					...
					<div class="mt-4 space-y-4">
						{#each data.similarThreads as similar}
							<a
								href="/a-staging/community/forums/{data.category.slug}/{similar.slug}"
								class="group block"
							>
