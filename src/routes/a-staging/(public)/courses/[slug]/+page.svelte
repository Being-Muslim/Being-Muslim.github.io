					...
					{#if isExpanded}
						<div class="border-t border-border">
							{#each mod.lessons as lesson, lessonIndex}
								...
								<a
									href="/a-staging/learn/{course.slug}/{lesson.slug}"
...
<section class="bg-bg-dark py-16 sm:py-24">
	<div class="mx-auto max-w-[1280px] px-4 text-center sm:px-6 lg:px-8">
		...
		<div class="mt-8 flex flex-wrap items-center justify-center gap-4">
			...
			<a href="/a-staging/courses" class="text-sm font-medium text-text-cream/70 hover:text-text-cream">
				Browse all courses
			</a>
		</div>
	</div>
