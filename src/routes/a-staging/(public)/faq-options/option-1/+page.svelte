	...
	<div class="mx-auto max-w-[1400px] px-6 lg:px-10">
		...
		<div class="bm-grid-sidebar">
			...
			<div style="position: sticky; top: 100px;">
				<div style="background: #e9e3da; border-radius: 12px; padding: 32px;">
					<h3 style="font-family: 'Source Serif 4', serif; font-size: 22px; font-weight: 400; color: #2a2018; margin: 0 0 12px; line-height: 1.25;">
						Still have questions?
					</h3>
					<p style="font-family: 'DM Sans', sans-serif; font-size: 14px; color: #8a7e70; line-height: 1.6; margin: 0 0 24px;">
					...
					<div style="display: flex; flex-direction: column; gap: 10px;">
						<a href="/a-staging/contact" class="bm-btn-dark" style="padding: 12px 24px; text-align: center; justify-content: center;">
							Ask a Question
						</a>
						<a href="/a-staging/contact" class="bm-btn-outline" style="padding: 12px 24px; text-align: center; justify-content: center;">
							Contact Us
						</a>
					</div>
				</div>
