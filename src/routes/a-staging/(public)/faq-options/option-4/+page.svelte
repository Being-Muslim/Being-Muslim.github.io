...
<svelte:head>
	<title>FAQ Option 4: Convert CTA — Being Muslim</title>
</svelte:head>
...
<section style="background: #fff;" class="bm-section-padding">
	<div class="mx-auto max-w-[1400px] px-6 lg:px-10">
		...
		<h1 style="font-family: 'Source Serif 4', serif; font-size: 28px; font-weight: 400; color: #2a2018; margin: 0 0 48px;">FAQ Option 4: Convert CTA</h1>
		...
		<div class="bm-grid-sidebar">
			...
			<!-- Right: Sticky Convert CTA Card (dark) -->
			<div style="position: sticky; top: 100px;">
				<div style="background: #2a2018; border-radius: 12px; padding: 32px;">
					<h3 style="font-family: 'Source Serif 4', serif; font-size: 22px; font-weight: 400; color: #fff; margin: 0 0 12px; line-height: 1.25;">
					...
					<a href="/a-staging/convert" class="bm-btn-white" style="padding: 12px 24px; width: 100%; text-align: center; justify-content: center;">
						Start Your Journey
					</a>
				</div>
			</div>
