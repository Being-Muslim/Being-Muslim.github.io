...
<svelte:head>
	<title>FAQ Option 5: Full Width — Being Muslim</title>
</svelte:head>
...
<section style="background: #fff; padding: 64px 0;">
	<div class="mx-auto max-w-[1400px] px-6 lg:px-10">
		...
		<h1 style="font-family: 'Source Serif 4', serif; font-size: 28px; font-weight: 400; color: #2a2018; margin: 0 0 48px;">FAQ Option 5: Full Width</h1>
