<footer style="background: #191918; padding: 64px 0 0;">
	<div class="mx-auto max-w-[1400px] px-6 lg:px-10">
		<div class="bm-grid-footer">
			<!-- Brand -->
			<div>
				<a href="/a-staging" style="display: flex; align-items: center; gap: 10px; text-decoration: none; margin-bottom: 16px;">
			...
			<div>
				...
				{#each [
					{ label: 'Articles', href: '/a-staging/learn' },
					{ label: 'Courses', href: '/a-staging/learn' },
					{ label: 'Resources', href: '/a-staging/learn' }
				] as link}
			...
			<div>
				...
				{#each [
					{ label: 'The Book', href: '/a-staging/shop' },
					{ label: 'Boxed Set', href: '/a-staging/shop' },
					{ label: 'Prayer Cards', href: '/a-staging/shop' },
					{ label: 'eBook', href: '/a-staging/shop' }
				] as link}
					<a href={link.href} class="bm-footer-link">{link.label}</a>
				{/each}
			</div>
			...
			<div>
				...
				{#each [
					{ label: 'Donate', href: '/a-staging/support' },
					{ label: 'Request Donation', href: '/a-staging/support' },
					{ label: 'Volunteer', href: '/a-staging/support' }
				] as link}
					<a href={link.href} class="bm-footer-link">{link.label}</a>
				{/each}
			</div>
			...
			<div>
				...
				{#each [
					{ label: 'About Us', href: '/a-staging/contact' },
					{ label: 'Contact', href: '/a-staging/contact' },
					{ label: 'Convert', href: '/a-staging/convert' },
					{ label: 'Privacy Policy', href: '/a-staging' }
				] as link}
					<a href={link.href} class="bm-footer-link">{link.label}</a>
				{/each}
			</div>
		...
		<div style="border-top: 1px solid rgba(255,255,255,0.08); padding: 20px 0; display: flex; flex-wrap: wrap; justify-content: space-between; align-items: center; gap: 12px;">
			...
			<div style="display: flex; gap: 24px;">
				<a href="/a-staging" class="bm-footer-link" style="font-size: 12px; color: rgba(255,255,255,0.3);">Privacy</a>
				<a href="/a-staging" class="bm-footer-link" style="font-size: 12px; color: rgba(255,255,255,0.3);">Terms</a>
				<a href="/a-staging/contact" class="bm-footer-link" style="font-size: 12px; color: rgba(255,255,255,0.3);">Contact</a>
			</div>
		</div>
	</div>
</footer>
