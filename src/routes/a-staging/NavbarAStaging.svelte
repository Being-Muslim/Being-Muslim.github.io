...
>
	<nav class="mx-auto flex h-[72px] max-w-[1400px] items-center justify-between px-6 lg:px-10">
		<!-- Logo -->
		<a href="/a-staging" class="flex items-center gap-2.5">
			<img
	...
	<div class="mobile-menu md:hidden" class:open={mobileOpen}>
		<div class="border-t border-border px-6 py-4">
			...
			{/each}
			<a href="/a-staging/contact" class="block mt-3 text-center bg-text-primary text-white py-2.5 rounded-full font-medium">Contact</a>
		</div>
	</div>
</header>
