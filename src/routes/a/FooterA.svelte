<footer style="background: #191918; padding: 64px 0 0;">
	<div class="mx-auto max-w-[1400px] px-6 lg:px-10">
		<div class="bm-grid-footer">
			<!-- Brand -->
			<div>
				<a href="/a" style="display: flex; align-items: center; gap: 10px; text-decoration: none; margin-bottom: 16px;">
			...
			<div>
				...
				{#each [
					{ label: 'Articles', href: '/a/learn' },
					{ label: 'Courses', href: '/a/learn' },
					{ label: 'Resources', href: '/a/learn' }
				] as link}
			...
			<div>
				...
				{#each [
					{ label: 'The Book', href: '/a/shop' },
					{ label: 'Boxed Set', href: '/a/shop' },
					{ label: 'Prayer Cards', href: '/a/shop' },
					{ label: 'eBook', href: '/a/shop' }
				] as link}
					<a href={link.href} class="bm-footer-link">{link.label}</a>
				{/each}
			</div>
			...
			<div>
				...
				{#each [
					{ label: 'Donate', href: '/a/support' },
					{ label: 'Request Donation', href: '/a/support' },
					{ label: 'Volunteer', href: '/a/support' }
				] as link}
					<a href={link.href} class="bm-footer-link">{link.label}</a>
				{/each}
			</div>
		...
		<div style="border-top: 1px solid rgba(255,255,255,0.08); padding: 20px 0; display: flex; flex-wrap: wrap; justify-content: space-between; align-items: center; gap: 12px;">
			...
			<div style="display: flex; gap: 24px;">
				<a href="/a" class="bm-footer-link" style="font-size: 12px; color: rgba(255,255,255,0.3);">Privacy</a>
				<a href="/a" class="bm-footer-link" style="font-size: 12px; color: rgba(255,255,255,0.3);">Terms</a>
				<a href="/a/contact" class="bm-footer-link" style="font-size: 12px; color: rgba(255,255,255,0.3);">Contact</a>
			</div>
		</div>
	</div>
</footer>
