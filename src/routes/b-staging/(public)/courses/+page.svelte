...
{#if featuredCourse}
	<section style="background: #faf9f5; padding: 0;">
		<div class="mx-auto max-w-[1400px] px-6 lg:px-10" style="margin-top: -32px; position: relative; z-index: 10;">
			<a href="/b-staging/courses/{featuredCourse.slug}" style="text-decoration: none; display: block;" class="bm-title-underline-parent">
	...
	<div class="mx-auto max-w-[1400px] px-6 lg:px-10">
		...
		<div class="bm-grid-3" style="gap: 24px; margin-top: 24px;">
			{#each filteredCourses as course (course.slug)}
				<a href="/b-staging/courses/{course.slug}" style="text-decoration: none; display: block;" class="bm-title-underline-parent">
