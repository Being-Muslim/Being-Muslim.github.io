...
<svelte:head>
	<title>Digital Edition (eBook) — Being Muslim Shop</title>
	<meta
		name="description"
		content="The complete Being Muslim guide in digital format — read on any device, anywhere."
	/>
</svelte:head>
		...
		<div style="display: grid; grid-template-columns: 1fr; gap: 40px; align-items: start;" class="md:!grid-cols-2 md:!gap-12">
			...
			<div>
				...
				<div style="display: flex; align-items: center; gap: 6px; margin-bottom: 16px;">
					...
					<span style="font-family: 'DM Sans', sans-serif; font-size: 13px; color: #8a7e70;">4.7 (64 reviews)</span>
				</div>
