			...
			columns: [
				{
					heading: 'Resources',
					links: [
						{ label: 'Articles', href: '/b-staging/learn', desc: 'In-depth guides on faith and practice' },
						{ label: 'Courses', href: '/b-staging/learn', desc: 'Structured learning at your own pace' },
						{ label: 'Brief Overview of Islam', href: '/b-staging/learn/brief-overview-of-islam', desc: 'Core beliefs, practices, and history' }
					]
				},
				{
					heading: 'Popular Topics',
					links: [
						{ label: "Beginner's Guide", href: '/b-staging/learn/beginners-guide', desc: 'First steps for new Muslims' },
						{ label: 'Islam and Other Faiths', href: '/b-staging/learn/islam-and-other-faiths', desc: 'Common ground and key differences' },
						{ label: 'View All Resources', href: '/b-staging/learn' }
					]
				}
			],
			featured: {
			...
			columns: [
				{
					...
					links: [
						{ label: 'Ready to Convert?', href: '/b-staging/convert', desc: 'Take the next step with guidance and support' },
						{ label: 'What to Expect', href: '/b-staging/convert', desc: 'Understanding the process and what comes after' },
						{ label: 'FAQ for New Muslims', href: '/b-staging/convert', desc: 'Answers to the most common questions' }
					]
				},
				{
					heading: 'Support',
					links: [
						{ label: 'Find a Community', href: '/b-staging/convert', desc: 'Connect with Muslims near you' },
						{ label: 'Mentorship Program', href: '/b-staging/convert', desc: 'One-on-one guidance from experienced Muslims' },
						{ label: 'Start Your Journey', href: '/b-staging/convert' }
					]
				}
			]
		},
			...
			columns: [
				{
					heading: 'Products',
					links: [
						{ label: 'Being Muslim: A Practical Guide', href: '/b-staging/shop/book', desc: 'The bestselling book' },
						{ label: 'The Complete Boxed Set', href: '/b-staging/shop/boxed-set', desc: 'Book, prayer cards, and more' },
						{ label: 'Prayer Reference Cards', href: '/b-staging/shop/prayer-cards', desc: 'Keep by your prayer mat' },
						{ label: 'Digital Edition (eBook)', href: '/b-staging/shop/ebook', desc: 'Read anywhere, instantly' }
					]
				}
			],
			featured: {
			...
			columns: [
				{
					...
					links: [
						{ label: 'Donate', href: '/b-staging/support', desc: 'Help fund resources for new Muslims' },
						{ label: 'Sponsor a Boxed Set', href: '/b-staging/support', desc: 'Gift a set to someone in need' },
						{ label: 'Volunteer', href: '/b-staging/support', desc: 'Join our team of contributors' },
						{ label: 'Support the Mission', href: '/b-staging/support' }
					]
				}
			]
		}
...
>
	<nav class="mx-auto flex h-[72px] max-w-[1400px] items-center justify-between px-6 lg:px-10">
		<!-- Logo -->
		<a href="/b-staging" class="flex items-center gap-2.5">
			<img
	...
	<div class="mobile-menu md:hidden" class:open={mobileOpen}>
		<div class="border-t border-border px-6 py-4">
			...
			{/each}
			<a href="/b-staging/contact" class="block mt-3 text-center bg-text-primary text-white py-2.5 rounded-full font-medium">Contact</a>
		</div>
	</div>
</header>
