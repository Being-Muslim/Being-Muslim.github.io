...
<svelte:head>
	<title>A Beginner's Guide to Being a Muslim — Being Muslim</title>
	<meta
		name="description"
		content="Practical guidance for new Muslims covering daily prayers, fasting, community life, and building a meaningful relationship with God."
	/>
</svelte:head>
	...
	<div class="mx-auto max-w-[1400px] px-6 lg:px-10 py-16 sm:py-24">
		<div class="mx-auto max-w-3xl">
			...
			<div class="flex flex-wrap items-center gap-3 mt-6">
				<span
					style="background: rgba(196,169,125,0.2); color: #c4a97d; font-family: 'DM Sans', sans-serif;"
					class="inline-flex items-center rounded-full px-3 py-1 text-xs font-medium"
				>
					New Muslims
				</span>
				<span
					style="color: rgba(240,235,227,0.5); font-family: 'DM Sans', sans-serif;"
			...
			<h1
				...
				class="mt-4 text-3xl font-bold leading-tight sm:text-4xl lg:text-5xl"
			>
				A Beginner's Guide to Being a Muslim
			</h1>

			<p style="color: rgba(240,235,227,0.7); font-family: 'DM Sans', sans-serif;" class="mt-4 text-lg leading-relaxed">
...
<section style="background-color: #f0ebe3;">
	<div class="mx-auto max-w-[1400px] px-6 lg:px-10 py-16">
		<article class="mx-auto max-w-3xl" style="font-family: 'DM Sans', sans-serif;">
			<h2 style="font-family: 'Source Serif 4', serif; color: #2a2018;" class="text-2xl mb-4">
				Taking the First Steps
			</h2>
			<p style="color: #5a5248; line-height: 1.8;" class="mb-6 text-base">
			...
			<h2 style="font-family: 'Source Serif 4', serif; color: #2a2018;" class="text-2xl mb-4 mt-10">
