...
<svelte:head>
	<title>Brief Overview of Islam — Being Muslim</title>
	<meta
		name="description"
		content="A concise introduction to the core beliefs, practices, and history of Islam — perfect for anyone beginning to explore the faith."
	/>
</svelte:head>
