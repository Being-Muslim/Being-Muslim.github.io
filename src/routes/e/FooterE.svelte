<footer style="background: #1C1917; padding: 64px 0 0;">
	<div class="bm-container">
				...
				<div style="display: flex; gap: 10px;">
					{#each [
						...
						<a href="#" aria-label={social.label} class="bm-social-icon">
							<svg viewBox="0 0 24 24" style="width: 14px; height: 14px; fill: rgba(250,245,235,0.6);">
								<path d={social.icon} />
							</svg>
						</a>
					{/each}
		...
		<!-- Bottom bar -->
		<div style="border-top: 1px solid rgba(250,245,235,0.08); padding: 20px 0; display: flex; flex-wrap: wrap; justify-content: space-between; align-items: center; gap: 12px;">
			<p style="font-family: 'Outfit', sans-serif; font-size: 12px; color: rgba(250,245,235,0.3);">&copy; 2026 The Being Muslim Project. All rights reserved.</p>
