<footer style="position: relative; background: #3A3632; padding: 0 0 0;">
	<!-- Organic curve SVG at top edge -->
	<div style="margin-top: -1px; line-height: 0; overflow: hidden;">
		<svg viewBox="0 0 1440 60" fill="none" xmlns="http://www.w3.org/2000/svg" style="display: block; width: 100%;">
			<path d="M0,0 C480,60 960,20 1440,50 L1440,60 L0,60 Z" fill="#3A3632"/>
		</svg>
	</div>
	...
	<div style="padding: 64px 0 0;">
		<div class="bm-container">
			<div class="bm-grid-footer">
				<!-- Brand -->
				<div>
					<a href="/g" style="display: flex; align-items: center; gap: 10px; text-decoration: none; margin-bottom: 16px;">
					...
					<div style="display: flex; gap: 10px;">
						{#each [
							...
							<a href="#" aria-label={social.label} class="bm-social-icon">
								<svg viewBox="0 0 24 24" style="width: 14px; height: 14px; fill: rgba(244, 237, 228, 0.6);">
									<path d={social.icon} />
								</svg>
							</a>
						{/each}
			...
			<!-- Bottom bar -->
			<div style="border-top: 1px solid rgba(244, 237, 228, 0.08); padding: 20px 0; display: flex; flex-wrap: wrap; justify-content: space-between; align-items: center; gap: 12px;">
				<p style="font-family: 'Manrope', sans-serif; font-size: 12px; color: rgba(244, 237, 228, 0.3);">&copy; 2026 The Being Muslim Project. All rights reserved.</p>
